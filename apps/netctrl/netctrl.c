...
/*---------------------------------------------------------------------------*/
static void handle_reg_request(netctrl_req_header_t *req) {
	netctrl_node_t * node;
	netctrl_rsp_header_t *rsp = (netctrl_rsp_header_t *)netctrl_sdata_buffer;
...
/*---------------------------------------------------------------------------*/
static void handle_renew_request(netctrl_req_header_t *req) {
	netctrl_node_t * node;
	netctrl_rsp_header_t *rsp = (netctrl_rsp_header_t *)netctrl_sdata_buffer;
	uint16_t reqId = req->id;
	normalize_req(req);
...
void netctrl_init() {
  ...
  //
  node_table_init(NETCTRL_TIMEOUT_VALUE);
  initialized = 1;
}
/*---------------------------------------------------------------------------*/
